...
def setup_scheduler():
    ...
    scheduler.add_job(_run_all_trackers_reddit, IntervalTrigger(minutes=30), id="reddit", replace_existing=True, next_run_time=now)
    ...
    scheduler.add_job(_run_all_trackers_bluesky, IntervalTrigger(minutes=30), id="bluesky", replace_existing=True, next_run_time=now)
    scheduler.add_job(_run_all_trackers_mastodon, IntervalTrigger(minutes=30), id="mastodon", replace_existing=True, next_run_time=now)
